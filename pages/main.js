...
const Main = () => {
  ...
  return (
    <div className="w-full relative bg-wwwbankofamericacom-nero overflow-y-auto flex flex-col items-start justify-start text-left text-base text-wwwbankofamericacom-black font-wwwbankofamericacom-arial-bold-16">
      ...
      <div className="self-stretch flex flex-col items-start justify-start pt-2 px-0 pb-0">
        <div className="self-stretch flex flex-col items-start justify-start gap-[10px]">
          <div className="self-stretch flex flex-row items-center justify-center py-0 px-2.5 gap-[4px]">
            <button className="cursor-pointer [border:none] py-0 pr-2.5 pl-0 bg-[transparent] flex flex-row items-center justify-center">
              <img
            ...
            <input
              ...
              height="48px"
            />
            <button className="cursor-pointer [border:none] p-2.5 bg-wwwbankofamericacom-crimson w-[53px] rounded-81xl h-[53px] overflow-hidden shrink-0 flex flex-row items-center justify-center box-border">
              <img
          ...
          <div className="self-stretch rounded-8xs bg-whitesmoke-300 overflow-hidden flex flex-col items-start justify-center pt-[5px] px-5 pb-[17px] font-wwwbankofamericacom-inter-regular-966">
          ...
          <div className="self-stretch flex flex-row items-center justify-start py-0 pr-2.5 pl-[15px] gap-[14px] text-sm text-wwwbankofamericacom-mine-shaft">
          ...
          <div className="self-stretch [background:linear-gradient(180deg,_#6a6a6a_30.83%,_rgba(0,_0,_0,_0.63))] flex flex-row items-center justify-start p-2.5 gap-[20px] text-sm text-wwwbankofamericacom-nero">
            <b className="relative leading-[26px]">
              Statement as of 05/01/2024
            </b>
          ...
          <div className="self-stretch flex flex-col items-start justify-start text-www-bankofamerica-com-1519199951171875x6432000122070312-default-dove-gray font-wwwbankofamericacom-roboto-regular-14-underline">
            <div className="self-stretch bg-wwwbankofamericacom-nero overflow-hidden flex flex-col items-start justify-center py-[17px] px-5 gap-[10px]">
              <div className="self-stretch flex flex-col items-start justify-start">
                <div className="self-stretch bg-whitesmoke-100 flex flex-col items-start justify-start p-2.5 gap-[10px] border-t-[1px] border-solid border-gainsboro-200 border-b-[1px]">
                  ...
                  <div className="self-stretch relative leading-[26px] text-steelblue">
                    Lupe G DES: PAYROLL 6380113 INON: ELECTRONIC CHECK
                  </div>
                  <div className="self-stretch flex flex-row items-center justify-between">
                    ...
                    <div className="relative leading-[26px]">-$1,500.00</div>
              ...
              <div className="self-stretch flex flex-col items-start justify-start">
                <div className="self-stretch bg-whitesmoke-100 flex flex-col items-start justify-start p-2.5 gap-[10px] border-t-[1px] border-solid border-gainsboro-200 border-b-[1px]">
                  ...
                  <div className="self-stretch relative leading-[26px] text-steelblue">
                    Chase DES:$TRANSFER ID: XXXXXX9876 INON: Construction! CO...
                  </div>
                  <div className="self-stretch flex flex-row items-center justify-between">
                    <div className="w-[69px] flex flex-row items-center justify-center max-w-[69px]">
                      <img
                    ...
                    <div className="relative leading-[26px]">-$995,000.00</div>
                    <div className="relative leading-[26px] text-right">
                      $392,523.80
                    </div>
                  </div>
              ...
              <div className="self-stretch flex flex-col items-start justify-start">
                <div className="self-stretch bg-whitesmoke-100 flex flex-col items-start justify-start p-2.5 gap-[10px] border-t-[1px] border-solid border-gainsboro-200 border-b-[1px]">
                  ...
                  <div className="self-stretch relative leading-[26px] text-steelblue">
                    Seattle Credit Union DES:$Transfer ID: XXXXX9348 INON:
                    Vanessa L
                  </div>
                  <div className="self-stretch flex flex-row items-center justify-between">
                    <div className="w-[69px] flex flex-row items-center justify-center max-w-[69px]">
                    ...
                    <div className="relative leading-[26px]">$800,000.00</div>
                    <div className="relative leading-[26px] text-right">
                      $1,387,523.80
                    </div>
                  </div>
              ...
              <div className="self-stretch flex flex-col items-start justify-start">
                <div className="self-stretch bg-whitesmoke-100 flex flex-col items-start justify-start p-2.5 gap-[10px] border-t-[1px] border-solid border-gainsboro-200 border-b-[1px]">
                  ...
                  <div className="self-stretch relative leading-[26px] text-steelblue">
                    ALLY BANK DES:$TRANSFER ID: XXXXXX9876 INON: Steve Fisherman
                    CO...
                  </div>
                  <div className="self-stretch flex flex-row items-center justify-between">
                    <div className="w-[69px] flex flex-row items-center justify-center max-w-[69px]">
                    ...
                    <div className="relative leading-[26px]">$5,700.00</div>
                    <div className="relative leading-[26px] text-right">
                      $587,523.80
                    </div>
                  </div>
              ...
              <div className="self-stretch flex flex-col items-start justify-start">
                <div className="self-stretch bg-whitesmoke-100 flex flex-col items-start justify-start p-2.5 gap-[10px] border-t-[1px] border-solid border-gainsboro-200 border-b-[1px]">
                  ...
                  <div className="self-stretch relative leading-[26px] text-steelblue">
                    MICROSOFT INC DES PAYROLL 6380113 INON: Subscribe to my
                    channel..
                  </div>
                  <div className="self-stretch flex flex-row items-center justify-between">
                    <div className="w-[69px] flex flex-row items-center justify-center max-w-[69px]">
            ...
            <div className="self-stretch [background:linear-gradient(180deg,_#6a6a6a_30.83%,_rgba(0,_0,_0,_0.63))] flex flex-row items-center justify-start p-2.5 gap-[20px] text-sm text-wwwbankofamericacom-nero font-wwwbankofamericacom-arial-bold-16">
              <b className="relative leading-[26px]">
                Statement as of 02/10/2023
              </b>
              <div className="flex flex-row items-center justify-start gap-[4px] text-base">
                <b className="relative leading-[26px]">{`(view statements) `}</b>
                <img
            ...
            <div className="self-stretch flex flex-col items-start justify-start py-2.5 px-5 gap-[10px]">
              <div className="self-stretch flex flex-col items-start justify-start">
                <div className="self-stretch bg-whitesmoke-100 flex flex-col items-start justify-start p-2.5 gap-[10px] border-t-[1px] border-solid border-gainsboro-200 border-b-[1px]">
                  <div className="flex flex-row items-center justify-start gap-[6px] max-w-[120px]">
                    <div className="rounded [background:linear-gradient(175.91deg,_#fff,_#f0f5f7)] overflow-hidden flex flex-row items-center justify-center p-1 border-[1px] border-solid border-dimgray">
                  ...
                  <div className="self-stretch relative leading-[26px] text-steelblue">
                    AMERICAN EXPRESS DES: CHECK DEPOSIT PMT ID:A9982 CHASE:
                    Christopher Scott..
                  </div>
                  <div className="self-stretch flex flex-row items-center justify-between">
                    <div className="w-[69px] flex flex-row items-center justify-center max-w-[69px]">
              ...
              <div className="self-stretch bg-whitesmoke-100 flex flex-col items-start justify-start p-2.5 gap-[10px] border-t-[1px] border-solid border-gainsboro-200 border-b-[1px]">
                ...
                <div className="self-stretch relative leading-[26px] text-steelblue">
                  ALLY BANK DES:$TRANSFER ID: XXXXXX9876 INON: Thank you! CO...
                </div>
                <div className="self-stretch flex flex-row items-center justify-between">
                  <div className="w-[69px] flex flex-row items-center justify-center max-w-[69px]">
                    <img
                  ...
                  <div className="relative leading-[26px]">-$40,000.29</div>
                  <div className="relative leading-[26px] text-right">
                    $2,449,373.89
                  </div>
                </div>
              ...
              <div className="self-stretch bg-whitesmoke-100 flex flex-col items-start justify-start p-2.5 gap-[10px] border-t-[1px] border-solid border-gainsboro-200 border-b-[1px]">
                ...
                <div className="self-stretch flex flex-row items-center justify-between">
                  ...
                  <div className="relative leading-[26px]">-$2,750.50</div>
                  <div className="relative leading-[26px] text-right">
                    $2,452,124.39
                  </div>
                </div>
